package com.cavoli.product.common.config;
...
public class SwaggerConfig {
	...
	public Docket productsApi() {
		...
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.cavoli.product.cavoli.com.sales.controller")).paths(PathSelectors.any())
